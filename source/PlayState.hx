...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Zoinks!', 0.2], //From 0% to 19%
		['How.', 0.4], //From 20% to 39%
		['Bad', 0.5], //From 40% to 49%
		['Bro What?', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Sex', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['Great', 0.9], //From 80% to 89%
		['Sick!', 1], //From 90% to 99%
		['GOD EATER', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'shaggy': //Shaggy Week LAWL
				var shaggy:BGSprite = new BGSprite('shaggy', -600, -200, 0.9, 0.9);
				add(shaggy);
